...
with open('chemistry_questions.csv', 'r', encoding='utf-8') as f:
    questions = list(csv.DictReader(f))

print(f'Total Chemistry questions to sync: {len(questions)}')
...
with open('chemistry_question_options.csv', 'r', encoding='utf-8') as f:
    options = list(csv.DictReader(f))

print(f'Total Chemistry options to sync: {len(options)}')
...
print('SUCCESSFULLY SYNCED ALL CHEMISTRY QUESTIONS AND OPTIONS TO SUPABASE!')
