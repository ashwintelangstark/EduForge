...
SUBJECT_ID = "a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12" # Chemistry
CHAPTER_ID = "b0eebc99-9c0b-4ef8-bb6d-6bb9bd380b13" # Some Basic Concepts of Chemistry

with open("all_extracted_chemistry_raw.txt", "r", encoding="utf-8") as f:
    raw_content = f.read()
...
for p_idx, p in enumerate(pages[1:], 1):
    ...
    for l in lines:
        if 'Chemistry | Some Basic Concepts' in l or 'NCERT Connector' in l or 'All the Best!' in l or 'NEET Plus' in l:
            continue
        if re.match(r'^\d+\.\d+\s+', l) and len(l) < 35: # section headers like 1.5 Laws of Chemical Combinations
            continue
...
for q in raw_questions:
    ...
    formatted_questions.append({
        ...
        "explanation": json.dumps([{"type": "text", "html": "<p>Refer to NCERT Class 11 Chemistry: Chapter 1 - Some Basic Concepts of Chemistry.</p>"}]),
        "difficulty": diff,
        "marks": 4,
        "negative_marks": 1,
...
print(f"Total Final Structured Chemistry Questions: {len(formatted_questions)}")
print(f"Total Final Structured Chemistry Options: {len(formatted_options)}")

# Write chemistry_questions.csv
with open("chemistry_questions.csv", "w", newline="", encoding="utf-8") as f:
...
# Write chemistry_question_options.csv
with open("chemistry_question_options.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.DictWriter(f, fieldnames=[
...
# Write insert_chemistry_questions.sql
with open("insert_chemistry_questions.sql", "w", encoding="utf-8") as f:
    f.write("-- =============================================================================\n")
    f.write("-- Complete Insert Script for Chemistry -> Some Basic Concepts of Chemistry\n")
    f.write("-- =============================================================================\n\n")
...
print("Files chemistry_questions.csv, chemistry_question_options.csv, and insert_chemistry_questions.sql successfully created!")
