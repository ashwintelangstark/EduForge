...
for p_idx, p in enumerate(pages[1:], 1):
    ...
    for l in lines:
        if 'Biology | The Living World' in l or 'NCERT Connector' in l or 'All the Best!' in l or 'NEET Plus' in l:
            continue
...
print(f"Total Final Structured Questions: {len(formatted_questions)}")
print(f"Total Final Structured Options: {len(formatted_options)}")
...
# Write insert_living_world_questions.sql
...
print("Files questions.csv, question_options.csv, and insert_living_world_questions.sql successfully created!")
